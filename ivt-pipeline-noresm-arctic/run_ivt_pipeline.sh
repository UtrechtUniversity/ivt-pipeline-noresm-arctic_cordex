#!/bin/bash
set -eo pipefail
#SBATCH --job-name=ivt_NORESM_CORDEX
#SBATCH --output=/ec/res4/scratch/nld1254/noresm/ivt-pipeline/ivt_noresm_CORDEX_%j.log
#SBATCH --error=/ec/res4/scratch/nld1254/noresm/ivt-pipeline/ivt_noresm_CORDEX_%j.log
...
# Integrated Vapor Transport (IVT) from the GCM NorESM2-MM.
...
#    Examples:
#      ./run_ivt_pipeline.sh
#        # Runs default: Feb 1985
#
#      ./run_ivt_pipeline.sh 2015 2015 03 06
#        # Runs  for Mar-Jun 2015
#
#      ./run_ivt_pipeline.sh 2014 2014 12 12
#        # Runs  for Dec 2014 only
#
# 2) Submit as a SLURM batch job:
#
#    sbatch run_ivt_pipeline.sh [START_YEAR] [END_YEAR] [START_MONTH] [END_MONTH]
#
...
#
#    Example:
#      sbatch run_ivt_pipeline.sh 1985 1985 02 02
#
# --------------------------------------------------------
# Note:
...
# === Paths ===
BASE_DIR="/ec/res4/scratch/nld1254/noresm"
MODEL_INPUT="${BASE_DIR}/RACMO_input" 
